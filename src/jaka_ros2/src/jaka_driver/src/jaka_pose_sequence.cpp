...
int main(int argc, char** argv)
{
  ...
  const std::vector<JointPose> poses = {
    ...
    {
      "pose_16",  // 76°, 100°, -145°, 180°, 100°, 104°
      {
        {"joint_1",  1.326450},
        {"joint_2",  1.745329},
        {"joint_3", -2.530727},
